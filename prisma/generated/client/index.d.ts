...
export namespace Prisma {
  ...
  */
   ...
   * Example findRaw
   */
  export type ExampleFindRawArgs = {
    /**
   ...
   */
  export type ExampleAggregateRawArgs = {
    /**
  ...
  export type VideoGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'User' ? UserGetPayload<S['select'][P]> :  P extends keyof Video ? Video[P] : never
  } 
    : Video
  : Video
